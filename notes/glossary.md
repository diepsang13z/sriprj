...
**Trạng thái quyết định (2026-09-23):** `RDR-0004` đã chốt RQ3; `RDR-0005` đã khóa khung lý thuyết (S-O-R + Kano/three-factor + Prospect Theory), khóa phạm vi dữ liệu 9.990 review, và xác nhận forgiveness **không được đo** — chỉ nêu trong văn hiến. `RDR-0005` cũng miễn tiêu chí bão hòa của `RDR-0001` (thay bằng tiêu chí "không còn phát hiện nào làm đổi thiết kế"), định nghĩa lại ba cụm tài liệu (C1 hiện tượng & định nghĩa, C2 cơ chế & điều kiện biên, C3 phản biện & baseline) và đóng băng core set 31 nguồn toàn văn.
