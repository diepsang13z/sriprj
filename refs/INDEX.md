...
**B. Truy cập mở (9 bài): 7 đã tải xong** — Li (SAGE) · Zhang · Das · Tengilimoglu · Leo · Hwang · Biasetton. **Còn 2 bài phải tải tay:**
   1. `10.1016/j.ipm.2025.104088` — C3 Liu, Ma & Dou → `refs/03_phenomenon/2025_liu_rating_inconsistency_airline.pdf`
   2. `10.1177/10963480241230957` — D5 Slevitch → `refs/06_counter_evidence/2024_slevitch_kano_categorization_critique.pdf`
   Link tải trực tiếp: log `0006` mục 7.2 phần B.

**C. Đóng thật — cần thư viện trường hoặc nhờ giảng viên (8 bài: 11 + 12):**
...
9. `10.1016/j.ijhm.2025.104397` — Kwon, W. (2026), IJHM → mục 4 *(trục lý thuyết RQ3)*
10. `10.1016/j.ijhm.2025.104242` — Albayrak et al. (2025), IJHM → mục 5
11. `10.1016/j.ijhm.2024.104057` — Xu et al. (2025), IJHM → mục 4
12. `10.1016/j.annals.2026.104208` — Zhong et al. (2026), Annals of TR → mục 4
13. `10.1007/s11042-024-19518-9` — Doan et al. (2025), MTAP → mục 7
14. `10.1016/j.dss.2025.114450` — Wang, D. et al. (2025), DSS → mục 3

**Tổng cần lấy: 14 bài** (8 từ Round 4 + 6 từ Round 3). Ba bài trọng yếu để quyết việc đóng khảo sát: **Kwon W.** (mục 4, ưu tiên 1) · **B1 Das** (mục 5, tải bằng trình duyệt) · **D1 Han & Anderson** (mục 6, cần thư viện).
