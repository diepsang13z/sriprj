...
- **Valdivia, A., et al. (2019).** _Inconsistencies on TripAdvisor reviews: A unified index between users and sentiment analysis methods_. _Neurocomputing, 353_, 3–16. [DOI](https://doi.org/10.1016/j.neucom.2018.09.096). **Vai trò:** provenance source ngoài cửa sổ; full text không OA nên chưa trích trực tiếp unified-index formula.
